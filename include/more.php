...
<body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/include/rooms.php">Room</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Super Avengers") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Single Room") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Executive Room") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Quad") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("John Sins Room") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Studio room") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Connecting Rooms") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Queen room") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                          <?php
                            ...
                            if(isset($_SESSION['id'])) {
                            // User is logged in, provide link to book.php
                            echo '<a href="/hotel_management/include/book.php?roomName=' . urlencode("Junior Suite") . '" class="btn btn-sm text-white custom-bg shadow-none">Book Now</a>';
                            } else {
                            // User is not logged in, provide link to login page
                            echo '<a href="/hotel_management/include/registration.php" class="btn btn-sm text-white custom-bg shadow-none">Book Now </a>';
                            }
        ...
        <h6 class="text-center bg-dark text-white p-3 mt-5">Designed by Sawan Yadav</h6>
