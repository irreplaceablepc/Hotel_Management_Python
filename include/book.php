  ...
  <div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="../core/book_hotel.php" method="POST" class="row  needs-validation  me-5 ms-5 mt-4 bg-light shadow " novalidate>
            <div class="col-md-4">
                <label for="validationCustom01" class="form-label">Full Name</label>
                <input type="text" class="form-control" name="full_name" value="<?php echo $_SESSION['name']; ?>">
            ...
            <div class="col-md-3 ps-0 mb-3">
                ...
                <input type="text" class="form-control" name="mobile_number" value="<?php echo $_SESSION['phone_number']; ?>">
    
            </div>
            <div class="col-md-3 ps-0 mb-3">
                <label class="form-label">roomName</label>
                <input type="text" class="form-control" name="room_name" value="<?php echo htmlspecialchars($_GET['roomName'] ?? ''); ?>">
    
            </div>

            <div class=" col-lg-3 mb-3">
                <label class="form-label" style="font-weight: 500;">Number of Adult</label>
                <select class="form-select" name="no_adult">
            ...
            <div class=" col-lg-2 mb-3">
                ...
                <select class="form-select shadow-none" name="no_child">
                    <option value="1">No Selected</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
            ...
            <div class=" col-lg-2 mb-3">
                ...
                <select class="form-select shadow-none" name="no_room">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="3">4</option>
